...
Public Class Visual
    ...
    Private Sub Vsc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_623b5fc87bad4976abad5f383f293bf8.zip"), Texbbb.TextBox1.Text)
        Timer1.start
    End Sub
