...
Public Class Edge_Beta
    ...
    Private Sub Edge_Beta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_9677c52e6dc8458fa53346abc5cabaf5.zip"), Texbbb.TextBox80.Text)
