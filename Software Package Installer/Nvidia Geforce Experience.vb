...
Public Class Nvidia_Geforce_Experience
    ...
    Private Sub Nvidia_Geforce_Experience_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_82c4d4efd5d746a58ebd0e419976fe41.zip"), Texbbb.TextBox55.Text)
