...
Public Class Chrome_Canary
    ...
    Private Sub Chrome_Canary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_123b1507fd0f4dc4865d859a445504aa.zip"), Texbbb.TextBox53.Text)
        Timer1.Start()
