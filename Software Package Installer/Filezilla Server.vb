...
Public Class Filezilla_Server
    ...
    Private Sub Filezilla_Server_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_be656d09438047e18abdc35fbebbf6d8.zip"), Texbbb.TextBox57.Text)
        ProgressBar1.Show()
