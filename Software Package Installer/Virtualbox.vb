...
Public Class Virtualbox
    ...
    Private Sub Virtualbox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_03b68c58e24342dbaa51aaeabaea8d96.zip"), Texbbb.TextBox14.Text)
        Timer1.Start()
