...
Public Class Opera
    ...
    Private Sub Opera_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_7e96b186187149438713c58932f01c17.zip"), Texbbb.TextBox31.Text)
