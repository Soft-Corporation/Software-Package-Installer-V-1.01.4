...
Public Class Crystaldiskinfo
    ...
    Private Sub Crystaldiskinfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_296ee99eb1ac49978a7c9d907dde14f1.zip"), Texbbb.TextBox48.Text)
