...
Public Class Firefox
    ...
    Private Sub Firefox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_c3fa6c58fabb47a2b2cc7f19d4be0a90.zip"), Texbbb.TextBox6.Text)
        Timer1.Start()
