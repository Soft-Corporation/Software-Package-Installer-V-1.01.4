...
Public Class OnlyOffice
    ...
    Private Sub OnlyOffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_cd89fde26f0d453680f1b586cd9e610f.zip"), Texbbb.TextBox35.Text)
