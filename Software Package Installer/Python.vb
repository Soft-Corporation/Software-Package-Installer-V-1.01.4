...
Public Class Python
    ...
    Private Sub Python_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_2fc0454bf2f844ecad3fca269ef598c6.zip"), Texbbb.TextBox37.Text)
