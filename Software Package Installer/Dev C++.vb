...
Public Class Dev_C__
    ...
    Private Sub Dev_C___Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_89d71f520ca246749fc2519c5a8832ab.zip"), Texbbb.TextBox45.Text)
        Timer1.Start()
