...
Public Class Hwmonitor
    ...
    Private Sub Hwmonitor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_70c63a14dae14123bf953adcabb2734b.zip"), Texbbb.TextBox9.Text)
        Timer1.Start()
