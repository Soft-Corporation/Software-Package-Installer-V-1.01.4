...
Public Class Mega
    ...
    Private Sub Mega_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_dde5e0bfb86f4a50a347b614bbf2e4b5.zip"), Texbbb.TextBox73.Text)
