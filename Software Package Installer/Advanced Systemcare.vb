...
Public Class Advanced_Systemcare
    ...
    Private Sub Advanced_Systemcare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        downlaod.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_8d9eaff9e169451c9c0434d8cbdf2c72.zip"), Texbbb.TextBox58.Text)
        Timer1.Start()
