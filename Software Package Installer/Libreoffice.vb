...
Public Class Libreoffice
    ...
    Private Sub Libreoffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d4b01d80d56e43988c5b9bbefe389460.zip"), Texbbb.TextBox3.Text)
        Timer1.Start()
