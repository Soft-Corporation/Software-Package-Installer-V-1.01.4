...
Public Class Nox_Player
    ...
    Private Sub Nox_Player_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a8df74849d7e44c2bacc6a9e13c44ccc.zip"), Texbbb.TextBox43.Text)
