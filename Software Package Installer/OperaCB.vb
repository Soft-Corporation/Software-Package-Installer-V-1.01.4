...
Public Class OperaCB
    ...
    Private Sub OperaCB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d1ce895c27ec4d01b425ce921bdaff0a.zip"), Texbbb.TextBox34.Text)
        Timer1.Start()
