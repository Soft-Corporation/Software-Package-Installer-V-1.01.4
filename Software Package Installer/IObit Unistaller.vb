...
Public Class IObit_Unistaller
    ...
    Private Sub IObit_Unistaller_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_161585c6149645a3ba525ee907e02190.zip"), Texbbb.TextBox8.Text)
        Timer1.Start()
