...
Public Class Obs
    ...
    Private Sub Obs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_2f43cbe7415a44d4a8f126f6d1de0788.zip"), Texbbb.TextBox19.Text)
        Timer1.Start()
